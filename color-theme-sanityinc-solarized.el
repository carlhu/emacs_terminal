...
`MODE' should be set to either 'light or 'dark."
  ...
  `(let* ((base03  "#042028")            ; (0.0159 0.1265 0.1597)
          ...
          (cyan    "#34a094")            ; (0.1468 0.5708 0.5250)
...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     ;; MMM-mode
     (mmm-code-submode-face ((,class (:background ,"#333333"))))
     (mmm-comment-submode-face ((,class (:inherit font-lock-comment-face))))
     (mmm-output-submode-face ((,class (:background ,"#333333"))))

     ;; Search
     (match ((,class (:foreground ,"#ffffff" :background ,nil :inverse-video nil ))))
     (isearch ((,class (:foreground ,"#ffffff" :background ,nil :inverse-video nil ))))
     (isearch-lazy-highlight-face ((,class (:foreground ,"#efefef" :background ,nil :inverse-video nil))))
     (isearch-fail ((,class (:background ,background :inherit font-lock-warning-face :inverse-video nil  :weight bold))))

     ;; IDO
     (ido-subdir ((,class (:foreground ,"#efefef"))))
     (ido-first-match ((,class (:foreground ,"#efefef"))))
     (ido-only-match ((,class (:foreground ,"#efefef"))))

     ;; Emacs interface
     (cursor ((,class (:background ,magenta))))
     (fringe ((,class (:background ,"#333333"))))
     (border ((,class (:background ,"#333333"))))
     (border-glyph ((,class (nil))))
     (highlight ((,class (:inverse-video nil :background ,"#333333"))))
     (gui-element ((,class (:background ,"#333333" :foreground ,normal))))
     (mode-line ((,class (:foreground nil :background ,"#333333" :weight bold
                                 :box (:line-width 1 :color ,normal)))))
     (mode-line-buffer-id ((,class (:foreground ,magenta :background nil))))
     (mode-line-inactive ((,class (:inherit mode-line
                                       :foreground ,faintest
                                       :background ,"#333333" :weight normal
                                       :box (:line-width 1 :color ,normal)))))
     (mode-line-emphasis ((,class (:foreground ,strong))))
     (mode-line-highlight ((,class (:foreground ,magenta :box nil :weight bold))))
     (minibuffer-prompt ((,class (:foreground ,blue))))
     (region ((,class (:background ,"#333333"))))
     (secondary-selection ((,class (:background ,"#333333"))))
     ...
     (show-paren-match ((,class (:background nil :foreground "#ffffff" :inverse-video nil))))
     (show-paren-mismatch ((,class (:background nil :foreground "#ffffff" :inverse-video nil))))
     ...
     (widget-field ((,class (:background ,"#333333" :box (:line-width 1 :color ,normal)))))
     ...
     (hl-sexp-face ((,class (:background ,"#333333"))))
     (highlight-80+ ((,class (:background ,"#333333"))))
     ...
     ;; RHTML
     (erb-delim-face ((,class (:background ,"#333333"))))
     (erb-exec-face ((,class (:background ,"#333333" :weight bold))))
     (erb-exec-delim-face ((,class (:background ,"#333333"))))
     (erb-out-face ((,class (:background ,"#333333" :weight bold))))
     (erb-out-delim-face ((,class (:background ,"#333333"))))
     (erb-comment-face ((,class (:background ,"#333333" :weight bold :slant italic))))
     (erb-comment-delim-face ((,class (:background ,"#333333"))))
