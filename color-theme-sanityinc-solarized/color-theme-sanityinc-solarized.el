...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (isearch-lazy-highlight-face ((,class (:foreground ,"#ffffff" :background ,nil :inverse-video nil))))
     (isearch-fail ((,class (:background ,background :inherit font-lock-warning-face :inverse-video nil  :weight bold))))

     ;; IDO
     (ido-subdir ((,class (:foreground ,"#ffffff"))))
     (ido-first-match ((,class (:foreground ,"ffffff"))))
     (ido-only-match ((,class (:foreground ,"ffffff"))))
     ...
     (show-paren-match ((,class (:background nil :foreground nil :inverse-video nil))))
